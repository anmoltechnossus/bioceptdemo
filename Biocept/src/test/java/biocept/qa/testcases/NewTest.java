...
//
// test = extent.createTest("Verify user is able to Login to Mission Control",
// "User should be able to login to Missin Control with valid credentials");
...
// //
// // Dashbord_ClientPortal dashbord_ClientPortal = new
// // Dashbord_ClientPortal();
...
// // = new TechOnlyProfessionalInterpretation();
// // boolean button =
// // techOnlyProfessionalInterpretation.goBacktoPhysicianPortalButton();
// // System.out.println(button);
// // WorkflowCommonMethods workflowCommonMethods = new
// // WorkflowCommonMethods();
...
// //
// FileInputStream("C:/Users/amarendra.singh/workspace/Biocept/src/main/java/biocept/qa/config/config.properties");
// // prop.load(ip);
// //
// // prop.setProperty("amar", "testing");
// // prop.store(new
// //
// FileOutputStream("C:/Users/amarendra.singh/workspace/Biocept/src/main/java/biocept/qa/config/config.properties"),
// // null);
...
// //// ArrayList<String> listOfString = new
// // ArrayList<String>(fixedLenghtList);
