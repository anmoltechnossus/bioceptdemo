...
// }
//
// @Test(priority = 6, description = "Verify user is able to open the BRAF
...
// }
//
// @Test(priority = 7, description = "Verify user is able to complete the BRAF
// Molecular Generic Resulting activity")
...
// }
//
// @Test(priority = 8, description = "Verify user is able to upload the Sequence
// image")
...
// }
//
// @Test(priority = 9, description = "Verify user is able to open BRAF
// Sequencing activity")
...
// }
//
// @Test(priority = 10, description = "Verify user is able to complete the BRAF
// Sequencing activity")
...
// }
//
// @Test(priority = 11, description = "Verify user is able to open BRAF
...
// }
//
// @Test(priority = 12, description = "Verify user is able to complete the BRAF
// Molecular Professional Interpretation activity")
...
// }
//
// @Test(priority = 13, description = "Verify user is able to Signoff the BRAF
