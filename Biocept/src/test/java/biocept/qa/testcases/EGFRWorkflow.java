...
// Macro File page for MolEGFR test")
...
// }
//
// @Test(priority = 6, description = "Verify user is able to open the MolEGFR
...
// }
//
// @Test(priority = 7, description = "Verify user is able to complete the
// MolEGFR Molecular Generic Resulting activity")
...
// }
//
// @Test(priority = 8, description = "Verify user is able to upload the MolEGFR
// Sequence image")
...
// }
//
// @Test(priority = 9, description = "Verify user is able to open MolEGFR
// Sequencing activity")
// public void MolEGFRSequencingActivityTitle() throws InterruptedException {
// explicitWait.invisibilityOfLoader();
// leftMenuItems.leftMenuSelection("Dashboards", "My Worklist");
// myWorklist.molecularSearch(AccessionID, "MolEGFR", "Sequencing",
...
// }
//
// @Test(priority = 10, description = "Verify user is able to complete the
// MolEGFR Sequencing activity")
...
// }
//
// @Test(priority = 11, description = "Verify user is able to open MolEGFR
...
// }
//
// @Test(priority = 12, description = "Verify user is able to complete the
// MolEGFR Molecular Professional Interpretation activity")
...
// }
//
// @Test(priority = 13, description = "Verify user is able to Signoff the
// MolEGFR Test Report from Molecular Review & Approve Worklist")
