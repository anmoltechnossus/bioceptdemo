...
// }
//
// @Test(priority = 1, description = "Verify user is able to create a new
// accession for Molecular Test")
...
// Molecular Test",
// "User should be able to create a acession with Molecular Test.");
...
// "PlaceNewOrderForMolecular" }, description = "Verify user is able to open the
// upload Macro File page")
// public void UploadMacroFile() throws InterruptedException, IOException {
// test = extent.createTest("Verify user is able to open the upload Macro File
// page",
// "User should be able to open and upload the Macro File for BRAF/KRAS/NRAS and
// MolEGFR test.");
// test.assignCategory("Molecular Workflow");
// explicitWait.invisibilityOfLoader();
...
// "UploadMacroFile" }, description = "Verify user is able to open the NRAS
// Molecular Generic Resulting Activity")
// public void NRASResultingActivityTitle() throws InterruptedException {
// test = extent.createTest("Verify user is able to open the NRAS Molecular
// Generic Resulting Activity",
// "After processing macro file user should be able to open Molecular Generic
// Resulting for NRAS test.");
// test.assignCategory("NRAS Workflow");
// explicitWait.invisibilityOfLoader();
// leftMenuItems.leftMenuSelection("Dashboards", "My Worklist");
// myWorklist.molecularSearch(AccessionID, "NRAS", "Molecular Generic
// Resulting",
...
// "NRASResultingActivityTitle" }, description = "Verify user is able to
// complete the NRAS Molecular Generic Resulting activity")
// public void NRASResultingUpdateResult() throws InterruptedException {
// test = extent.createTest("Verify user is able to complete the NRAS Molecular
// Generic Resulting activity",
// "User should be able to complete the NRAS Molecular Generic Resulting using
// complete button.");
// test.assignCategory("NRAS Workflow");
...
// "NRASResultingUpdateResult" }, description = "Verify user is able to open the
// BRAF Molecular Generic Resulting Activity")
// public void BRAFResultingActivityTitle() throws InterruptedException {
// test = extent.createTest("Verify user is able to open the BRAF Molecular
// Generic Resulting Activity",
// "After processing macro file user should be able to open Molecular Generic
// Resulting for BRAF test.");
...
// "BRAFResultingActivityTitle" }, description = "Verify user is able to
// complete the BRAF Molecular Generic Resulting activity")
// public void BRAFResultingUpdateResult() throws InterruptedException {
// test = extent.createTest("Verify user is able to complete the BRAF Molecular
// Generic Resulting activity",
// "User should be able to complete the BRAF Molecular Generic Resulting using
// complete button.");
// test.assignCategory("BRAF Workflow");
// molecularGenericResulting.braf_kras_nras_GenericUpdateResult();
// workflowCommonMethods.molecularSaveButton();
...
// "BRAFResultingUpdateResult" }, description = "Verify user is able to open the
// KRAS Molecular Generic Resulting activity")
// public void KRASResultingActivityTitle() throws InterruptedException {
// test = extent.createTest("Verify user is able to open the Molecular Generic
// Resulting for KRAS test",
// "After processing macro file user should be able to open Molecular Generic
// Resulting for KRAS test.");
...
// "KRASResultingActivityTitle" }, description = "Verify user is able to
// complete the KRAS Molecular Generic Resulting activity")
// public void KRASResultingUpdateResult() throws InterruptedException {
// test = extent.createTest("Verify user is able to complete the KRAS Molecular
// Generic Resulting activity",
// "User should be able to complete the KRAS Molecular Generic Resulting using
// complete button.");
// test.assignCategory("KRAS Workflow");
// molecularGenericResulting.braf_kras_nras_GenericUpdateResult();
// workflowCommonMethods.molecularSaveButton();
...
// }
//
// // @Test(priority= 6, description="Verify user is able to open the Molecular
// // Generic Resulting for MolEGFR test")
// // public void MolEGFRResultingActivityTitle() throws InterruptedException{
// // test=extent.createTest("Verify user is able to open the Molecular Generic
// // Resulting for MolEGFR test", "After processing macro file user should be
// // able to open Molecular Generic Resulting for MolEGFR test.");
...
// "KRASResultingUpdateResult" }, description = "Verify user is able to upload
// the Sequence image")
// public void UploadSequenceImages() throws InterruptedException, IOException {
// test = extent.createTest("Verify user is able to upload the Sequence image",
// "User should be able to upload the Sequence file from Sequence image
// section.");
// test.assignCategory("Molecular Workflow");
// explicitWait.invisibilityOfLoader();
// leftMenuItems.leftMenuSelection("Macros Molecular", "Upload Macro File");
...
// "UploadSequenceImages" }, description = "Verify user is able to open NRAS
// Molecular Professional Interpretation activity")
// public void NRASPIActivityTitle() throws InterruptedException {
// test = extent.createTest("Verify user is able to open NRAS Molecular
// Professional Interpretation activity",
// "User should be able to open the NRAS Molecular Professional Interpretation
...
// "NRASPIActivityTitle" }, description = "Verify user is able to complete the
// NRAS Molecular Professional Interpretation activity")
// public void NRASPIActivityResult() throws InterruptedException {
// test = extent.createTest(
// "Verify user is able to complete the NRAS Molecular Professional
// Interpretation activit",
// "User should be able to complete the NRAS Molecular Professional
// Interpretation activity using complete button.");
// test.assignCategory("NRAS Workflow");
...
// "NRASPIActivityResult" }, description = "Verify user is able to Signoff the
// NRAS Test Report from Molecular Review & Approve Worklist")
// public void NRASReportSignoff() throws InterruptedException {
// test = extent.createTest(
// "Verify user is able to Signoff the NRAS Test Report from Molecular Review &
// Approve Worklist",
// "After complete PI activity user should be able to Signoff the NRAS Test
// Report from Molecular Review & Approve Worklist");
// test.assignCategory("NRAS Workflow");
// explicitWait.invisibilityOfLoader();
...
// "NRASReportSignoff" }, description = "Verify user is able to open BRAF
// Sequencing activity")
// public void BRAFSequencingActivityTitle() throws InterruptedException {
// test = extent.createTest("Verify user is able to open BRAF Sequencing
// activity",
// "After processing Sequencing file user should be able to open Sequencing
// activity for BRAF test.");
// test.assignCategory("BRAF Workflow");
// myWorklist.molecularSearch(AccessionID, "BRAF", "Sequencing",
...
// "BRAFSequencingActivityTitle" }, description = "Verify user is able to
// complete the BRAF Sequencing activity")
// public void BRAFSequencingActivityResult() throws InterruptedException {
// test = extent.createTest("Verify user is able to complete the BRAF Sequencing
// activity",
// "User should be able to complete the BRAF Sequencing activity using complete
// button.");
// test.assignCategory("BRAF Workflow");
// explicitWait.invisibilityOfLoader();
...
// "BRAFSequencingActivityResult" }, description = "Verify user is able to open
// KRAS Sequencing activity")
// public void KRASSequencingActivityTitle() throws InterruptedException {
// test = extent.createTest("Verify user is able to open KRAS Sequencing
// activity",
// "After processing Sequencing file user should be able to open Sequencing
// activity for KRAS test.");
// test.assignCategory("KRAS Workflow");
// explicitWait.invisibilityOfLoader();
// // leftMenuItems.leftMenuSelection("Dashboards","My Worklist");
...
// "KRASSequencingActivityTitle" }, description = "Verify user is able to
// complete the KRAS Sequencing activity")
// public void KRASSequencingActivityResult() throws InterruptedException {
// test = extent.createTest("Verify user is able to complete the KRAS Sequencing
// activity",
// "User should be able to complete the KRAS Sequencing activity using complete
// button.");
// test.assignCategory("KRAS Workflow");
// explicitWait.invisibilityOfLoader();
// sequencing.braf_kras_nras_sequencingUpdateResult();
...
// "KRASSequencingActivityResult" }, description = "Verify user is able to open
// BRAF Molecular Professional Interpretation activity")
// public void BRAFPIActivityTitle() throws InterruptedException {
// test = extent.createTest("Verify user is able to open BRAF Molecular
// Professional Interpretation activity",
// "User should be able to open the BRAF Molecular Professional Interpretation
// activity from My worklist.");
// test.assignCategory("BRAF Workflow");
// explicitWait.invisibilityOfLoader();
...
// "BRAFPIActivityTitle" }, description = "Verify user is able to complete the
// BRAF Molecular Professional Interpretation activity")
// public void BRAFPIActivityResult() throws InterruptedException {
// test = extent.createTest(
// "Verify user is able to complete the BRAF Molecular Professional
// Interpretation activit",
// "User should be able to complete the BRAF Molecular Professional
// Interpretation activity using complete button.");
// test.assignCategory("BRAF Workflow");
// molecularProfessionalInterpretation.piUpdateResult();
// workflowCommonMethods.molecularSaveButton();
...
// "BRAFPIActivityResult" }, description = "Verify user is able to Signoff the
// BRAF Test Report from Molecular Review & Approve Worklist")
// public void BRAFReportSignoff() throws InterruptedException {
// test = extent.createTest(
// "Verify user is able to Signoff the BRAF Test Report from Molecular Review &
// Approve Worklist",
// "After complete PI activity user should be able to Signoff the BRAF Test
// Report from Molecular Review & Approve Worklist");
// test.assignCategory("BRAF Workflow");
// explicitWait.invisibilityOfLoader();
// molecularReviewAndApproveWorklist.reportSignoff();
...
// "BRAFReportSignoff" }, description = "Verify user is able to open KRAS
// Molecular Professional Interpretation activity")
// public void KRASPIActivityTitle() throws InterruptedException {
// test = extent.createTest("Verify user is able to open KRAS Molecular
// Professional Interpretation activity",
// "User should be able to open the KRAS Molecular Professional Interpretation
// activity from My worklist.");
// test.assignCategory("KRAS Workflow");
// explicitWait.invisibilityOfLoader();
...
// "KRASPIActivityTitle" }, description = "Verify user is able to complete the
// KRAS Molecular Professional Interpretation activity")
// public void KRASPIActivityResult() throws InterruptedException {
// test = extent.createTest(
// "Verify user is able to complete the KRAS Molecular Professional
// Interpretation activit",
// "User should be able to complete the KRAS Molecular Professional
// Interpretation activity using complete button.");
// test.assignCategory("KRAS Workflow");
// molecularProfessionalInterpretation.piUpdateResult();
// workflowCommonMethods.molecularSaveButton();
...
// "KRASPIActivityResult" }, description = "Verify user is able to Signoff the
// KRAS Test Report from Molecular Review & Approve Worklist")
// public void KRASReportSignoff() throws InterruptedException {
// test = extent.createTest(
// "Verify user is able to Signoff the KRAS Test Report from Molecular Review &
// Approve Worklist",
// "After complete PI activity user should be able to Signoff the KRAS Test
// Report from Molecular Review & Approve Worklist");
// test.assignCategory("KRAS Workflow");
// explicitWait.invisibilityOfLoader();
// molecularReviewAndApproveWorklist.reportSignoff();
